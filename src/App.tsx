        ...
        {activeView === "guide" && (
          <section>
            ...
            <section>
              ...
              <p>
                このシステムは、プリムローズ祭実行委員会などの企画運営において、領収書を年度およびプロジェクトごとに管理し、提出者側と会計側の記録を照合するためのものです。領収書画像を保存するだけでなく、日付、店名、カテゴリ、金額、メモ、操作履歴を記録し、支出内容の確認や会計資料の整理に役立てます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                まず、実行委員会内で共有された全体パスワードを入力してシステムに入室します。その後、画面上部で年度を選択します。管理者がその年度のプロジェクトを作成し、提出者用、会計担当者用、管理者用のパスワードを設定します。各担当者は、自分の役割に応じたパスワードでプロジェクトに入室します。提出者は領収書画像や支出内容を登録し、会計担当者は会計側の記録を登録して提出者側の内容と照合します。内容が一致している場合、会計担当者または管理者が確認完了にします。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                画面上部の年度選択を切り替えると、その年度に属するプロジェクトだけが表示されます。年度を切り替えた場合、別年度のプロジェクトは自動的に閉じられます。これにより、年度ごとの会計資料を混同せずに管理できます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                会計担当者は、会計側の記録を登録・編集し、提出者側の内容と照合します。内容が一致している場合、領収書を確認済みにできます。
              </p>

              <h4>管理者</h4>

              <p>
                管理者は、提出者側・会計側の登録内容の管理、確認解除、削除、CSV出力、プロジェクト設定、パスワード変更、全体パスワード変更を行えます。
              </p>
            </section>
          </section>
        )}
                ...
                >
                  ...
                  <section className="form-section upload-section">
                    <div>
                      ...
                      <p>
                        スマートフォンではカメラ撮影、PCでは画像ファイルの選択ができます。
                        無料運用のため、画像は保存前に自動で圧縮されます。
                      </p>
                    </div>
        ...
        {activeView === "policy" && (
          <section>
            ...
            <section>
              ...
              <p>
                プリムローズ祭実行委員会（以下「委員会」といいます）は、委員会が提供する領収書管理システムその他関連するサービスを利用する方（以下「ユーザー」といいます）の個人情報および会計資料の重要性を十分に認識し、その取り扱いにあたって以下の事項を遵守します。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、個人情報および会計資料を取り扱うにあたり、個人情報の保護に関する法令、学校の定める規則、その他関連する規範を遵守します。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報を、領収書および支出内容の確認、年度別・プロジェクト別の会計資料の整理、提出者・会計担当者・管理者による照合、支出内容の集計、問い合わせ対応、会計確認、監査補助、次期以降の委員会への引き継ぎ、システムの保守・改善、その他プリムローズ祭の運営に必要な範囲で利用します。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                領収書画像は、支出内容を確認するための証憑として保存します。ユーザーは、領収書画像に不要な個人情報が写り込んでいないかを確認したうえで登録するものとします。委員会は、領収書画像を会計確認および運営管理に必要な範囲でのみ利用し、目的外に利用しません。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報を、会計確認、監査補助、引き継ぎその他運営上必要な期間保存します。保存された情報は、管理者による削除その他委員会が必要と認める措置が行われない限り、年度別およびプロジェクト別に保存されます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ユーザーは、全体パスワードおよび役割別パスワードを適切に管理し、関係者以外に共有しないものとします。パスワードが第三者に知られた可能性がある場合は、管理者または当該年度の担当者に速やかに連絡するものとします。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報を、会計確認、運営管理、問い合わせ対応、監査補助、引き継ぎ等に必要な範囲で、委員会内の担当者または次期以降の委員会に共有する場合があります。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、法令に基づく場合、学校その他関係機関への報告が必要な場合、またはユーザーの同意がある場合を除き、取得した個人情報を第三者に提供しません。第三者に情報を提供する場合には、提供先において適切な管理が行われるよう必要な措置を講じます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報の紛失、破壊、改ざん、漏えい、不正アクセス等を防止するため、アクセス権限の管理、操作履歴の記録、パスワード管理、通信の暗号化、担当者への注意喚起等、必要かつ適切な安全管理措置を講じます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ユーザー本人から、自己に関する情報の開示、訂正、削除等の申し出があった場合、委員会は必要な確認を行ったうえで、合理的な範囲で対応します。ただし、会計記録、監査、引き継ぎ、法令または学校の規則に基づき保存が必要な情報については、削除等に応じられない場合があります。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、システムの運用、データの保存、認証、問い合わせ対応等のために、外部サービスを利用する場合があります。この場合、委員会は利用目的の達成に必要な範囲で情報を取り扱い、外部サービスの利用規約およびプライバシーポリシーを確認したうえで、適切な管理に努めます。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、個人情報および会計資料の保護を適切に行うため、本方針を必要に応じて見直し、改善に努めます。内容を変更した場合は、システム内、公式ウェブサイト、または委員会が適切と判断する方法で周知します。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                本方針および委員会が提供するサービスにおける情報の取り扱いに関するお問い合わせは、当該年度のプリムローズ祭実行委員会の担当者までお願いいたします。
              </p>
            </section>
          </section>
        )}
