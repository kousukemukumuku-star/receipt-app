        ...
        {activeView === "guide" && (
          <section>
            ...
            <section>
              ...
              <p>
                まず、実行委員会内で共有された全体パスワードを入力してシステムに入室します。その後、画面上部で年度を選択します。管理者がその年度のプロジェクトを作成し、提出者用、会計担当者用、管理者用のパスワードを設定します。各担当者は、自分の役割に応じたパスワードでプロジェクトに入室します。提出者は領収書画像や支出内容を登録し、会計担当者は会計側の記録を登録して提出者側の内容と照合します。内容が一致している場合、管理者が確認完了にします。
              </p>
            </section>
        ...
        {activeView === "policy" && (
          <section>
            ...
            <section>
              ...
              <p>
                プリムローズ祭実行委員会（以下、「委員会」という。）は、委員会が提供する領収書管理システムその他関連するサービスを利用する方（以下、「ユーザー」という。）の個人情報および会計資料の重要性を十分に認識し、その取り扱いにあたって以下の事項を遵守します。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、領収書管理システムの利用にあたり、年度、プロジェクト名、ユーザーの役割情報、領収書画像、日付、店名、カテゴリ、金額、メモ、学籍番号、氏名、登録・編集・確認に関する操作履歴、全体パスワードおよび役割別パスワードによる入室に必要な情報、アクセス日時、利用端末に関する情報、その他会計確認および運営管理に必要な情報を取得する場合がある。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報を、領収書および支出内容の確認、年度別・プロジェクト別の会計資料の整理、提出者・会計担当者・管理者による照合、支出内容の集計、問い合わせ対応、会計確認、監査補助、次期以降の委員会への引き継ぎ、システムの保守・改善、その他プリムローズ祭の運営に必要な範囲で利用する。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                領収書画像は、支出内容を確認するための証憑として保存する。また、ユーザーは、領収書画像に不要な個人情報が写り込んでいないかを確認したうえで登録しなければならない。委員会は、領収書画像を会計確認および運営管理に必要な範囲でのみ利用し、目的外に利用してはならない。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、取得した情報を、会計確認、監査補助、引き継ぎその他運営上必要な期間保存します。保存された情報は、管理者による削除その他委員会が必要と認める措置が行われない限り、年度別およびプロジェクト別に保存される。
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                委員会は、システムの運用、データの保存、認証、問い合わせ対応等のために、外部サービスを利用する場合があります。この場合、委員会は利用目的の達成に必要な範囲で情報を取り扱い、外部サービスの利用規約およびプライバシーポリシーを確認したうえで、適切な管理に努める。
              </p>
            </section>
